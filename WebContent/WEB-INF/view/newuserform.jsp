...
<body>
	...
	<div class="container">
		...
		<div class="navbar-header ">
			...
			<a class="navbar-brand"><span>Create</span> Acount </a>
		</div>
	</div>
	</nav>
	...
	<div class="form-new-user">
		<div class="container">
			<form id="the_form" onsubmit="return user_form_Valid()" method="post"
				action="insertUser.html">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class=" marg_buton10 form-group form-group-resize-new-blo">
							<input id="_password" onblur="user_password_Valid()"
								...
								placeholder="PassWord From 6 char to 40 ">
						</div>
					</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class=" marg_buton10 form-group form-group-resize-new-blo">
							<div id="datepicker" class="input-group date"
								...
								<input name="dateOfBirth" onblur="user_date_Valid()" id="_date"
									class="form-control" type="text" placeholder="" /> <span
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margn-top-10">
						<div id="__country" class="alert alert-danger hidden" role="alert">OPS
							!! Not Valid Make Sur From Your Country</div>
					</div>
				</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class=" marg_buton10 form-group form-group-resize-new-blo">
							<input id="_city" onblur="user_city_Valid()" type="text"
								class="form-control " name="address.city" placeholder="City">
						</div>
					</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class=" marg_buton10 form-group form-group-resize-new-blo">
							<button type="submit" onclick="user_form_Valid()"
								class="btn btn-success lead bold-font">Create An Acount
							</button>
						</div>
					</div>
