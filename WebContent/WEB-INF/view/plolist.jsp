				...
				<c:forEach items="${listblogs }" var="blogg">
					<div class="blo-item">
						<div class="blo-item-top row">
							...
							<div class="col-sm-6 hidden-xs text-right marg10">
								<h4>
									<span class="bold-font">Auther</span> <a class="auther-name">
										<span id="auth">${blogg.userBlop.name }</span>
									</a>
								</h4>
							</div>
						</div>
