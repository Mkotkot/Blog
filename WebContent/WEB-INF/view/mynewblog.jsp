    ...
    <div class="container">
        ...
        <div class="navbar-header ">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                    data-target="#mynavpar" aria-expanded="false">
        ...
        <div class="collapse navbar-collapse " id="mynavpar">
            <ul class="nav navbar-nav navbar-right">
                <li onclick="activehome()" id="_home" class=""><a href="/Blog/Blogs">Home</a></li>
                <li onclick="activeabut()" id="_about" class=""><a href="/Blog/user_data">About Me</a></li>
                <li onclick="activenewblog()" id="_newblog" class="active"><a href="/Blog/NewBlog">New BLOG</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="blo-1">
    <div class="container">
        ...
        <form id="the_form" onsubmit="return blog_form_Valid()" method="post" action="insertBlog.html">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h3><span class="label label-default lead">Blog Titel</span></h3>

                    <div class=" marg_buton10 form-group form-group-resize-new-blo">
                        <input onblur="blog_titel_Valid()" id="_titel" type="text" class="form-control " name="titel"
                               placeholder="Blog Titel">
                    </div>
                </div>

                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                    <div id="__titel" class="alert alert-danger marg_buton11 hidden " role="alert">OPS !! Not Valid Make
                        Sure From Blog Titel
                    </div>
                </div>
            </div>

            <h3><span class="label label-default lead">BLO Supject</span></h3>

            <div class="form-group">
                <textarea id="_supject" type="text" name="subject" class="form-control " placeholder="BLO Supject"></textarea>
            </div>

            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class=" marg_buton10 form-group form-group-resize-new-blo">
                        <button type="submit" onclick="blog_form_Valid()" class="btn btn-success lead bold-font"> Save
                            BLOG
                        </button>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margn-top-70">
                    <div id="__form" class="alert alert-danger hidden" role="alert">OPS !! Not Valid Check The Fildes
                    </div>
                </div>
            </div>
        </form>
...
<div class="copy-right">
    <div class="container">
        <div class="inner-copy-right center-block text-center ">
            <p class="lead">Copyright &copy; 2015 <span>Mohamed Kotkot</span> All rights reserved</p>
        </div>
    </div>
</div>
